  ...
  describe("/cache/", function()
    ...
    describe("GET", function()
      ...
      it("[FAILURE] should return an error when the key is invalid", function()
        response, status = http_client.get(BASE_URL.."hello")
    ...
    describe("DELETE", function()
      ...
      it("[SUCCESS] should invalidate an entity", function()
        ...
        -- Delete
        local response, status = http_client.delete(BASE_URL.."ALL_APIS_BY_DIC")
        assert.equal(200, status)
      ...
      it("[SUCCESS] should invalidate all entities", function()
        ...
        -- Delete
        local response, status = http_client.delete(BASE_URL)
        assert.equal(200, status)
